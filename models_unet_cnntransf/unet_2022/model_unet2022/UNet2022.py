...
from models_unet_cnntransf.unet_2022.model_unet2022.initialization import InitWeights_He
from models_unet_cnntransf.unet_2022.model_unet2022.neural_network import SegmentationNetwork
...
def init_model(model, pre_trained_weight=None):
    if pre_trained_weight:
        checkpoint = pre_trained_weight
        ck = {}
        for i in model.state_dict():
            if i.replace('decoder','encoder') in checkpoint:  # there is a mistake in the name of the key of the pretrained model
                ...
                ck.update({i: model.state_dict()[i]})
